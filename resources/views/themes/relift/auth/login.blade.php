...
@section('body')
    <script>
        document.getElementsByTagName('body')[0].setAttribute('class', 'login-page');
    </script>
    <div class="page-header header-filter" style="background-image: url({{ media(theme('auth_background')) }}); background-size: cover; background-position: top center;">
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6 ml-auto mr-auto">
                    <div class="card card-signup">
                        ...
                        <form class="form" method="post" action="{{ url('login') }}">
                            ...
                            <p class="description text-center"><a href="{{ url('register.html') }}">没有账号？去注册一个</a></p>
                            <div class="card-body">
